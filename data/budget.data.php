...
class BudgetData extends BudgetModel
{
	...
	public function BudgetIncomeUpdate()
	{
		try
		{
			...
			// Build database statement
			$sql = "CALL BudgetIncomeUpdate(:BudgetIncomeID,:BudgetNumber,:IncomeTypeID,:IncomeType,:PayCycleID,:PayCycle,:TakeHomePay,:HourlyRate,:PlannedHours,:Salary,:YearDeduct)";
